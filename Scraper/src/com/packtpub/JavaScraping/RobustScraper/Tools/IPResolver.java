...
/**
 * IPResolver uses the free service provided by freegeoip.net to resolve IP
 * addresses into a geographic location
 * 
 * @author rmitchell
 * 
 */
public class IPResolver {
	...
	/**
	 * Simple method, returns anything between the \<CountryName\> tags
	 * (presumably the country of origin)
	 * 
