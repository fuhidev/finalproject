...
public class Webpage {
	 ...
	 * @param urlObj
	 *            Java url object used by several methods, global variable here
	 *            for convenience
	 */
	public String url;
	public URL urlObj;
	...
	/**
	 * Used to overload the getRedirect(Boolean secondRedirect) method if no
	 * Boolean is provided. By default, this will perform only one redirect and
	 * return the result.
	 * 
	 * @return Returns final redirected URL, or an empty string if none was
	 *         found.
	 ...
	 * @throws IOException
	 */
	public String getRedirect(Boolean secondRedirect)
		...
		if (secondRedirect) {
			try {
				...
				HttpURLConnection newCon = (HttpURLConnection) newURL
						.openConnection();
