...
public class DollarPrice1 extends AbstractPrice implements JSONAware {
	private String name;
	...
	public DollarPrice1(int id, String name, double buyCash, double buyTransfer, double sellPrice, String date) {
		super(id);
		this.name = name;
	...
	public DollarPrice1(int id, String name, String buyCash, String buyTransfer, String sellPrice, String date) {
		super(id);
		this.name = name;
	...
	public String toJSONString() {
		...
		sb.append("{"); // Báº¯t Ä‘áº§u má»™t Ä‘á»‘i tÆ°á»£ng JSON lÃ  dáº¥u
						// má»Ÿ ngoáº·c nhá»�n
		...
		sb.append("}"); // Káº¿t thÃºc má»™t Ä‘á»‘i tÆ°á»£ng JSON lÃ  dáº¥u
						// Ä‘Ã³ng ngoáº·c nhá»�n
	...
	public boolean equals(Object obj) {
		...
		if (!super.equals(obj))
			return false;
		if (!(obj instanceof DollarPrice1))
			return false;
		DollarPrice1 other = (DollarPrice1) obj;
